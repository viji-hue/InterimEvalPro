...
export const QUESTION_BANK = [
...

  {
    ...
    topic: "Spring Core",
    difficulty: "hard",
    q: "Explain the three ways to configure Spring beans (XML-based, annotation-based, and Java-based). When would you choose each approach, and show code examples for all three?",
    key: "1. XML-based: Define beans in bean.xml using <bean> tags. Best for legacy projects. 2. Annotation-based: Use @Component, @Autowired, @ComponentScan in bean.xml. Modern, reduces XML. 3. Java-based: Use @Configuration class with @Bean methods, no XML at all. Most type-safe and IDE-friendly. Choose Java-based for new projects for full type safety; use XML for legacy; use annotations for balance. All three achieve the same result but differ in configuration style and IDE support.",
    ...
    evalHints: ["XML configuration", "annotation-based", "Java-based", "@Configuration", "@Bean", "@Component", "@ComponentScan", "@Autowired", "bean.xml", "AnnotationConfigApplicationContext", "type safety"]
  }
];
